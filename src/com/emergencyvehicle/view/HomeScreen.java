...
//Method to clear all the textfields and reset the combobox
    ...
    /**
     * Method to sort the vehicle data by vehicle number using MergeSort.
     *
     ...
     *
     * This method retrieves the search key from the text field. If the search
     * key is empty, it refills the vehicle table with the original data.
     * Otherwise, it calls the method to search for vehicles based on the
     * provided search key and populates the table with the results.
     *
     */
    ...
    /**
     * Handles the action event triggered when the search text field is
     * submitted.
     *
     * This method retrieves the search key from the text field. If the search
     * key is empty, it refills the vehicle table with the original data.
     ...
     * provided search key and populates the table with the results.
     *
     * @param evt the action event triggered by the text field submission
     */
    ...
    /**
     * Searches for vehicles based on the provided search key and populates the
     * vehicle table with the results.
     *
     * This method clears the existing data in the table, performs a binary
     * search for vehicles by type and location, and populates the table with
     * the search results. It also logs the search process to the console and
     * populates the service request column if applicable.
     *
     * @param searchKey the key used to search for vehicles by type or location
     */
    private void searchAndPopulateTable(String searchKey) {
        ...
        // Binary search algorithm for `Vehicle Type` and `Location`
        BinarySearch binarySearch = new BinarySearch();
        searchResults.addAll(binarySearch.searchByType(searchKey, vehicles, 0, vehicles.size() - 1));
        searchResults.addAll(binarySearch.searchByLocation(searchKey, vehicles, 0, vehicles.size() - 1));
